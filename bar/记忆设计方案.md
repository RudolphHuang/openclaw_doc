...
| 方法 | 路径 | 描述 |
|------|------|------|
| GET | /api/agent_memory | 获取记忆列表（支持分类筛选） |
| POST | /api/agent_memory | 创建记忆（用户手动创建） |
| GET | /api/agent_memory/:id | 获取记忆详情 |
| PUT | /api/agent_memory/:id | 更新记忆 |
| DELETE | /api/agent_memory/:id | 删除记忆 |
| GET | /api/agent_memory/index | 获取记忆索引（供 LLM 使用） |

### 8.2 聊天记忆接口

| 方法 | 路径 | 描述 |
|------|------|------|
| POST | /api/chat/agent_memory/read | LLM 工具：读取记忆详情 |
| POST | /api/chat/agent_memory/create | LLM 工具：创建记忆 |
| POST | /api/chat/agent_memory/update | LLM 工具：更新记忆 |
| POST | /api/chat/agent_memory/delete | LLM 工具：删除记忆 |
| POST | /api/chat/agent_memory/list | LLM 工具：列出记忆 |

### 8.3 用户设置接口

| 方法 | 路径 | 描述 |
|------|------|------|
| GET | /api/settings/agent_memory | 获取记忆设置 |
| PUT | /api/settings/agent_memory | 更新记忆设置 |
...
**共存原则**：
- 新系统使用独立的表（`agent_memories`, `agent_memory_index`）
