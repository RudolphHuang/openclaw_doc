...
flowchart TB
    subgraph MemoryStore["MemoryStore"]
        subgraph Data["数据"]
            ...
            Entries["entries: MemoryEntry[]"]
            Current["currentEntry: MemoryEntry"]
        end
        
        subgraph UIState["UI 状态"]
            Loading["isLoading: boolean"]
            Filter["filter: {category, search}"]
            Sort["sortBy: 'accessed' | 'created' | 'count'"]
        end
        
        subgraph ChatState["聊天状态"]
            ReadEnabled["memoryReadEnabled: boolean"]
            WriteEnabled["memoryWriteEnabled: boolean"]
        end
    end
